 ...
 * - Menu system (File, Connection, Audio call, Video call, Keys, Help)
...
private:
    ...
    /**
     * @brief Handles incoming file offer from CLI output
     */
    void handleFileOffer(const QString &sender, const QString &filename, const QString &sizeStr);

    /**
     * @brief Applies new chat font from settings
     */
    void onChatFontChanged(const QFont &font);
