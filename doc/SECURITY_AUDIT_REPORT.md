  ...
  1. Plaintext Secret Key Export (key-exchange.c:364-372)
  ...
  // Затем шифровать secret_key с помощью derived_key через AES-256-GCM

  2. Ключ в аргументах командной строки (audio_call.c)
  ...
  // При расшифровке проверять временную метку
